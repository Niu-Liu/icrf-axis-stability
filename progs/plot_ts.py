...
def ts_coord_plot(souname, coordts, plotdir="../plots/ts"):
    ...
    ax0.errorbar(coordts["mjy"], coordts["dra"], yerr=coordts["ra_err"],
                 fmt="b.", ecolor="grey", elinewidth=0.1, ms=1)
    ax1.errorbar(coordts["mjy"], coordts["ddec"], yerr=coordts["dec_err"],
                 fmt="b.", ecolor="grey", elinewidth=0.1, ms=1)
...
def ts_rhopa_plot(souname, coordts, plotdir="../plots/ts"):
    ...
    ax0.plot(coordts["mjy"], coordts["pa"], "b.", ms=1)
    ...
    ax1.plot(coordts["mjy"], coordts["rho"], "b.", ms=1)
...
def ts_sc_plot(souname, coordts, plotdir="../plots/ts"):
    ...
    sc = ax.scatter(coordts["dra"], coordts["ddec"], c=coordts["mjy"], s=5,
                    cmap="copper")
...
def plot_ts(souname, plotdir="../plots/ts"):
