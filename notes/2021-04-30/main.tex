...
\end{table}
    ...
    These orientation angles are generally less than $\mathrm{10\,\mu as}$, except for opa2019a.
    When comparing the ICRF2 with the ICRF3 $S/X$-band catalogs, the orientation angle is also on the order of $\mathrm{10\,\mu as}$.
    As a result, the difference in the axis direction between celestial reference frames represented by different catalogs at $S/X$-band is generally within $\mathrm{10\,\mu as}$.
